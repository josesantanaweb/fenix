  ...
  return (
    <div className="exchange-box-x1">
      <div className="flex justify-between items-center">
        ...
        <span className="icon-swap text-3xl mt-5 w-[10%] text-center text-transparent bg-gradient-to-r from-outrageous-orange-500 to-festival-500 bg-clip-text"></span>
        <div className="flex flex-col w-full px-2">
