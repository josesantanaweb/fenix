    ...
    <MainBox>
      <div className="flex flex-col items-center justify-between w-full
       xl:flex-row relative z-10">
        <div className="lg:ms-5 xl:w-1/2">
          ...
          <div className="flex lg:gap-5 gap-3 box bg-shark-400 bg-opacity-40 
           2xl:w-[390px] lg:h-auto lg:w-96 rounded-lg mb-5 items-center justify-center lg:justify-normal">
            <div>
