...
const InactiveVote = ({ handlerChange }: InactiveVoteProps) => {
  return (
    <div className="flex w-full flex-wrap justify-between  gap-2 p-5 text-white border-solid border-1 border-shark-400 bg-shark-400 bg-opacity-40 rounded-xl">
      ...
      <div
        className="flex  gap-2 w-/2 p-2 ms-10 xl:mx-0 items-center
         bg-shark-100 text-shark-100 bg-opacity-40 border border-solid rounded-lg
         border-shark-400  text-sm"
      >
